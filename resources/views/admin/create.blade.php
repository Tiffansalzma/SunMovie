    ...
    @csrf
        ...
        <a href= "{{ url('home-admin') }}" class="btn btn-secondary"><< Back</a>
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='judul_film' value="{{ Session::get('judul_film') }}" id="judul_film">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="genre" class="col-sm-2 col-form-label">Genre</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='genre' value="{{ Session::get('genre') }}" id="genre">
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='bioskop' value="{{ Session::get('bioskop') }}" id="bioskop">
                </div>
            </div>
            <div class="mb-3 row">
